...
@section('content')
    ...
    <form action="{{ route('profile.update', $dataUser->id) }}" method="POST" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kelas" value="{{ $dataUser->siswa->kelas }}"
                name="id_kelas" readonly>
        </div>
        <div class="mb-3">
            <label for="jurusan" class="form-label">Jurusan</label>
            <input type="text" class="form-control" id="jurusan" value="{{ $dataUser->siswa->jurusan }}"
